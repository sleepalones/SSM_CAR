    ...
    <script type="text/javascript">
        ...
        layui.extend({
            ...
            tableIns=table.render({
                ...
                ,url:'${ctx}/role/loadAllRole.do' //数据接口
            ...
            $("#doSearch").click(function(){
                ...
                tableIns.reload({
                    url:"${ctx}/role/loadAllRole.do?"+params
                })
            });
            ...
            table.on('tool(roleTable)', function(obj){
                ...
                if(layEvent === 'del'){ //删除
                    layer.confirm('真的删除【'+data.rolename+'】这个角色吗', function(index){
                        //向服务端发送删除指令
                        $.post("${ctx}/role/deleteRole.do",{roleid:data.roleid},function(res){
                            layer.msg(res.msg);
                            //刷新数据 表格
                            tableIns.reload();
                        })
            ...
            function openSelectRoleMenu(data){
                ...
                mainIndex=layer.open({
                    ...
                    yes:function(index, layero){
                        ...
                        //保存角色和菜单的关系
                        $.post("${ctx}/role/saveRoleMenu.do",params,function(obj){
                            layer.msg(obj.msg);
                        })
                    },
                    success:function(index){
                        ...
                        menuTree = dtree.render({
                            ...
                            checkbarData: "choose" ,
                            url: "${ctx}/role/initRoleMenuTreeJson.do?roleid="+data.roleid // 使用url加载（可与data加载同时存在）
                        });
                    }
                });
            }
            ...
            function deleteBatch(){
                ...
                layer.confirm('真的删除选中的这些角色吗', function(index){
                    //向服务端发送删除指令
                    $.post("${ctx}/role/deleteBatchRole.do",params,function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
