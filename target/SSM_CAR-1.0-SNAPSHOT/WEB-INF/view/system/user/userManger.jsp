...
<script type="text/javascript">
    ...
    layui.extend({
        ...
        tableIns=table.render({
            ...
            ,url:'${ctx}/user/loadAllUser.do' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${ctx}/user/loadAllUser.do?"+params
            })
        });
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.realname+'】这个用户吗', function(index){
                    //向服务端发送删除指令
                    $.post("${ctx}/user/deleteUser.do",{userid:data.userid},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
                ...
                layer.confirm('真的重置【'+data.realname+'】这个用户的密码吗', function(index){
                    //向服务端发送删除指令
                    $.post("${ctx}/user/resetUserPwd.do",{userid:data.userid},function(res){
                        layer.msg(res.msg);
                    })
                });
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些用户吗', function(index){
                //向服务端发送删除指令
                $.post("${ctx}/user/deleteBatchUser.do",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
        ...
        function openselectUserRole(data){
            mainIndex=layer.open({
                ...
                yes:function(index, layero){
                    ...
                    //保存
                    $.post("${ctx}/user/saveUserRole.do",params,function(obj){
                        layer.msg(obj.msg);
                    })
                },
                success:function(index){
                    ...
                    var roleTableIns=table.render({
                        ...
                        ,url:'${ctx}/user/initUserRole.do?userid='+data.userid //数据接口
                        ,title: '角色列表'//数据导出来的标题
