...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate','layedit' ], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${ctx}/news/loadAllNews.do' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${ctx}/news/loadAllNews.do?"+params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(newsTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                layer.confirm('真的删除【'+data.title+'】这个公告吗', function(index){
                    //向服务端发送删除指令
                    $.post("${ctx}/news/deleteNews.do",{id:data.id},function(res){
                        layer.msg(res.msg);
                        //刷新数据 表格
                        tableIns.reload();
                    })
        ...
        function deleteBatch(){
            ...
            layer.confirm('真的删除选中的这些公告吗', function(index){
                //向服务端发送删除指令
                $.post("${ctx}/news/deleteBatchNews.do",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
