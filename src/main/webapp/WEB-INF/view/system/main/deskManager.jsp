...
<script type="text/javascript">
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，" +timeValue+"好！ 欢迎使用NCVT租车系统。当前时间为： "+newDate+"　"+week;
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        //用户数量
        $.get("${ctx }/resources/json/userList.json",function(data){
